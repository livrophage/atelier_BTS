...
$user = sqlCommand("SELECT * FROM utilisateur WHERE email=:email",[':email'=>$email],$conn);
var_dump($user);
if ($user != [] && password_verify($psw,$user[0]["mdp"])){ //vérifie si l'utilisateur existe et si le mdp est bon
